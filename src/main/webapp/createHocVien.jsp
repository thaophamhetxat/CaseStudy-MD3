...
<div class="container">
    ...
    <form action="/hocvien?action=create" method="post">
        <table class="table">
            <thead>
            <tr>
                <th>Name</th>
            ...
            <tbody>
            <tr>
                <td><input placeholder="nhap name" name="name"></td>
                <td><input placeholder="nhap date" name="date"></td>
                <td><input placeholder="nhap address" name="address"></td>
                <td><input placeholder="nhap phones" name="phone"></td>
