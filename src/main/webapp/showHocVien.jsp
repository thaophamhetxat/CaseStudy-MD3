...
<div class="container">
    ...
    <table class="table">
        ...
        <tbody>
        <c:forEach items="${listHocVien}" var="hocvien" varStatus="loop">
            <tr>
                <td>${hocvien.name}</td>
                <td>${hocvien.date}</td>
                ...
                <td>${hocvien.phone}</td>
                <td>${hocvien.email}</td>
                <td>${hocvien.classroom}</td>
                <td>
                    <form>
                        <a href="/hocvien?action=edit&index=${loop.index}" class="btn btn-warning">Edit</a>
                    </form>
                </td>
                <td>
                    <form>
                        <a href="/hocvien?action=delete&index=${loop.index}" class="btn btn-danger">Delete</a>
                    </form>
                </td>
            </tr>
        </c:forEach>
